...
<div class="main-header-img">
        <img class="w-100" src="../../uploads/your_needs_en/YourNeedBannerEn4_1648462857.jpg" alt="Breadcrumb Banner">
...
<div class="abt-single mt-4">
    <div class="container">
       <!--  <h2 class="sub-page-topic py-3">Business Loan And More?</h2>
        <div class="row pb-3">
            <p>Reach your business goals with our financial support. Get a business loan today from the best finance provider in <?php echo $row['country']; ?> under competitive interest rates.</p>
...
We, <?php echo $row['name']; ?> here to provide you with the simplest solution to cover any nature of business expenses. We can provide you with quick working capital in no time. All you have to do is to open a current account in the bank and become eligible</p>
            ...
            <div class="col-md-6 text-center pl-0 pr-md-2 p-0 md-imgSize">
                <img class="img-responsive w-100 mx-3" src="https://www.cclk.lk/uploads/your_needs_en/YourNeedEn4_1643110230.jpg" alt="">
            </div>
        </div> -->
...
We, <?php echo $row['name']; ?> here to provide you with the simplest solution to cover any nature of business expenses. We can provide you with quick working capital in no time. All you have to do is to open a current account in the bank and become eligible</p>
            ...
            <div class="col-md-6 text-center pl-0 pr-md-2 p-0 md-imgSize">
                <img class="img-responsive w-100" src="../../uploads/your_needs_en/YourNeedEn4_1643110230.jpg" alt=""
                data-aos="fade-up"
                data-aos-offset="200"
