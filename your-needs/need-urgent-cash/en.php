...
<div class="main-header-img">
        <img class="w-100" src="../../uploads/your_needs_en/YourNeedBannerEn2_1652930389.jpg" alt="Breadcrumb Banner">
            ...
            <ul class="ul-second clr-chng">
                    ...
                    <a class="nav-link-second  active " href="en.php">
                        ...
                        Need Urgent Cash?
                                ...
                                <li class="nav-item-second">
                    <a class="nav-link-second " href="../saving-for-future/en.php">
...
<div class="abt-single mt-4">
    <div class="container">
       <!--  <h2 class="sub-page-topic py-3">Need Urgent Cash?</h2>
        <div class="row pb-3">
            <p>The fastest financial facility in the market offered by the best finance company in <?php echo $row['country']; ?> will cover your urgent cash needs within an hour.</p>
           <div class="col-md-6 pl-0 pr-md-2 p-0">
                <h4>Need Urgent Cash?</h4>
                <p>Are you in an urgency of cash? Can’t think about a financial source and don’t have much time to find?<br />
Go to the nearest <?php echo $row['name']; ?> branch with your motor bike or three wheeler. The <?php echo $row['name']; ?> team is ready to facilitate your financial needs within an hour.</p>
            </div>

            <div class="col-md-6 text-center pl-0 pr-md-2 p-0 md-imgSize">
                <img class="img-responsive w-100 mx-3" src="https://www.cclk.lk/uploads/your_needs_en/YourNeedEn2_1652930948.jpg" alt="">
            </div>
        </div> -->
...
Go to the nearest <?php echo $row['name']; ?> branch with your motor bike or three wheeler. The <?php echo $row['name']; ?> team is ready to facilitate your financial needs within an hour.</p>
            ...
            <div class="col-md-6 text-center pl-0 pr-md-2 p-0 md-imgSize">
                <img class="img-responsive w-100" src="../../uploads/your_needs_en/YourNeedEn2_1652930948.jpg" alt=""
                data-aos="fade-up"
                data-aos-offset="200"
