...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Your Needs - <?php echo $row['name']; ?></title>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbar-content">
        ...
        <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown dropdown-mega position-static">
            ...
            <a class="nav-link active  dropdown-toggle" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">YOUR NEEDS</a>
...
<div class="main-header-img">
        <img class="w-100" src="../../uploads/your_needs_en/YourNeedBannerEn3_1648462913.jpg" alt="Breadcrumb Banner">
        
    <div class="inner-topic">
        <h3>Your Needs</h3>
        <div class="bredcrumb">
            <a href="../../en.php">Home</a><i class="fas fa-chevron-right"></i> <a href="en.php">YOUR NEEDS</a>
        </div>
...
<div class="second-menu bg-light py-4">
    <div class="container">
        <div class="row py-3">
            <ul class="ul-second clr-chng">
                                                <li class="nav-item-second">
                    <a class="nav-link-second " href="../need-a-leasing/en.php">
                        <img src="../../uploads/your_needs_en/YourNeedIcon1_1645451076.svg" alt="Need List">
                        Need a Leasing?
                    </a>
                </li>
                
                                <li class="nav-item-second">
                    <a class="nav-link-second " href="../need-urgent-cash/en.php">
                        <img src="../../uploads/your_needs_en/YourNeedIcon2_1652933172.svg" alt="Need List">
                        Need Urgent Cash?
                    </a>
                </li>
                
                                <li class="nav-item-second">
                    <a class="nav-link-second  active " href="en.php">
                        <img src="../../uploads/your_needs_en/YourNeedIcon3_1645451215.svg" alt="Need List">
                        Saving for Future?
                    </a>
                </li>
                
                                <li class="nav-item-second">
                    <a class="nav-link-second " href="../business-loan-and-more/en.php">
                        <img src="../../uploads/your_needs_en/YourNeedIcon4_1645451259.svg" alt="Need List">
...
<div class="abt-single mt-4">
    <div class="container">
       <!--  <h2 class="sub-page-topic py-3">Saving For Future?</h2>
        <div class="row pb-3">
            <p>Secure your future today. Save with the most trustworthy finance company in <?php echo $row['country']; ?> and get the highest benefits and rewards for your savings.</p>
           <div class="col-md-6 pl-0 pr-md-2 p-0">
                <h4>Saving for Future?</h4>
                <p>Are you looking for the best saving method for a secured future? Invest in Funds management which enables you to get the highest return to your money. <br />
We, <?php echo $row['name']; ?> is ready to accept funds of all the non-senior citizens and senior citizens of <?php echo $row['country']; ?> at the highest interest rates in the market.</p>
            </div>

            <div class="col-md-6 text-center pl-0 pr-md-2 p-0 md-imgSize">
                <img class="img-responsive w-100 mx-3" src="https://www.cclk.lk/uploads/your_needs_en/YourNeedEn3_1643022428.jpg" alt="">
            </div>
        </div> -->

        <div class="row mb-5 selectedNeed">
...
We, <?php echo $row['name']; ?> is ready to accept funds of all the non-senior citizens and senior citizens of <?php echo $row['country']; ?> at the highest interest rates in the market.</p>
            ...
            <div class="col-md-6 text-center pl-0 pr-md-2 p-0 md-imgSize">
                <img class="img-responsive w-100" src="../../uploads/your_needs_en/YourNeedEn3_1643022428.jpg" alt=""
                data-aos="fade-up"
                data-aos-offset="200"
