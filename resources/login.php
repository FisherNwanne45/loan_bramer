     ...
     <form action=" "  method="POST" class="d-flex">
                           <span><?php echo $error; ?></span>
                            ...
                            <div class=" align-items-center">
                                    ...
                                    <input type="text"class="form-control" placeholder="Email / User ID" name="username" required><br>
                                 
                                    <input type="text" class="form-control" placeholder="Enter Password" name="password" required>
                               <br>
                                    <button type="submit" value="Submit" name="submit" class="btn btn-primary ">Login</button><!-- /.thm-btn -->
...
<?php echo $row['addr']; ?>, <?php echo $row['country']; ?>
          ...
          <div class="col-md-12 disclaimer">
            ...
            <small class="d-block text-center text-light">A finance company licensed by the Monetary Board of the Central Bank of <?php echo $row['country']; ?> under the Finance Business Act No.42 of 2011.Reg.No.:PQ269.  | Date of Incorporation - 1982-10-04</small>
