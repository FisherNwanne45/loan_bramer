...
<head>
  ...
  <?php session_unset(); } ?>
  <form class="form-horizontal row-fluid" method="post" action="image_upload.php" enctype="multipart/form-data" >
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="cid"  value="<?php echo strtoupper($rand); ?>" id="cid"  readonly="true" class="span8"  >
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="name" id="name" placeholder="Enter Name of Receiver" class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="rank" id="rank" placeholder="Enter Address" class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="phone" id="phone" placeholder="Enter Phone Number" class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="type" id="type" placeholder="Enter the type of Loan" class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="amt" id="amt" placeholder="Enter Loan Amount" class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="rate" id="rate" placeholder="Enter Interest rate" class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="dur" id="dur" placeholder="Enter Payback Duration" class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="coldate" id="coldate" placeholder="Country of Receiver" class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="paydate" id="paydate" placeholder="Enter Loan Repayment Date ..." class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" name="status" id="status" data-placeholder="Select Status" class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea type="text" name="remark" id="remark" placeholder="Enter Remarks ..." class="span8"></textarea>
										...
										<div class="control-group">
											<div class="controls">
												<input name="save" type="submit" onClick="MM_validateForm('name','','R','rank','','R','image','','R','cid','','R','phone','','R','type','','R','amt','','R','rate','','R','dur','','R','coldate','','R','paydate','','R','status','','R','remark','','R',);return document.MM_returnValue" value="Create Loan"> 
											</div>
										</div>
									</form>
							</div>
