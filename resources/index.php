                        ...
                        <div class="content">
                            <div class="btn-controls">
                                <div class="btn-box-row row-fluid">
                                    <a href="identity.php" class="btn-box big span4"><i class=" icon-random"></i><b>Create</b>
                                        <p class="text-muted">
                                            New Tracking</p>
                                    </a><a href="change_password.php" class="btn-box big span4"><i class="icon-user"></i><b>Change</b>
                                        <p class="text-muted">
                                            Password</p>
                                    </a><a href="logout.php" class="btn-box big span4"><i class="icon-save"></i><b>Logout</b>
                                        <p class="text-muted">
                                            Back to Site</p>
                                    </a>
                                </div>
  ...
  <?php session_unset(); } ?>
      ...
      ?>
									...
									<i class="icon-edit"> Edit</i>
                                                ...
                                                <td class="center">
                                                    <a class="btn btn-small btn-danger" href="delete.php?id=<?php echo $row['id']; ?>" >
