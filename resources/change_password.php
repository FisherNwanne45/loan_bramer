...
<div><?php if(isset($message)) { echo $message; } ?>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" placeholder="<?php echo $row['username']; ?>" class="span8" disabled>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<div class="input-prepend">
												 <input class="span8" type="text" placeholder="Enter New Username" name="username"  value="<?php echo $row['username']; ?>">       
												</div>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<div class="input-append">
													<input type="text" placeholder="Enter New password" class="span8" type="password" name="password"   value="<?php echo $row['password']; ?>"> 
												</div>
											</div>
										</div>
