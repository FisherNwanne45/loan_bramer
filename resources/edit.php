...
<div><?php if(isset($message)) { echo $message; } ?>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="coldate" id="coldate" value="<?php echo $row['coldate']; ?>" class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" name="status" id="status" value="<?php echo $row['status']; ?>" data-placeholder="Select Status" class="span8" required>
													<option value="">Select Status</option>
													<option value="Approved">Approved</option>
													<option value="Under Review">Under Review</option>
													<option value="Processing">Processing</option>
													<option value="Payments pending">Payments pending</option>
														<option value="Submit Documents">Submit Documents</option></select>
											</div>
										</div>
											...
											<div class="controls">
												<textarea type="text" rows="4" name="remark" id="remark" value="<?php echo $row['remark']; ?>" class="span8"><?php echo $row['remark']; ?></textarea>
