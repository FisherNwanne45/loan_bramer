...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
            content="<?php echo $rows['name']; ?> is a leading finance company in <?php echo $rows['country']; ?> whose purpose is uplifting the lives of people with simple act of love.">
        ...
        <meta name="keywords"
            content="leading finance company in <?php echo $rows['country']; ?>, Funds managements, vehicle leasing, buy a vehicle, get a loan, Funds management rates">
        ...
        <title>Track Result - <?php echo $rows['name']; ?></title>
        ...
        <meta property="og:site_name" content="<?php echo $rows['name']; ?>" />
        ...
        <meta name="twitter:card" content="<?php echo $rows['name']; ?>">
        <meta name="twitter:site" content="<?php echo $rows['name']; ?>">
        <meta name="twitter:title" content="<?php echo $rows['name']; ?>">
        <meta name="twitter:description"
            content="<?php echo $rows['name']; ?> is a leading finance company in <?php echo $rows['country']; ?> whose purpose is uplifting the lives of people with simple act of love.">
        <meta name="twitter:creator" content="<?php echo $rows['name']; ?>">
                ...
                <div class=" main-nav w-100">
                    ...
                    <div class=" d-flex justify-content-end top-bar align-items-center">
                        ...
                        <div class="top_item contactDetails">
                            ...
                            <a href="tel:<?php echo $rows['phone']; ?>">Call Us : <?php echo $rows['phone']; ?></a>
                            ...
                            <a href="mailTo:<?php echo $rows['email']; ?>">Email :
                                <span><?php echo $rows['email']; ?></span></a>
          ...
          <a class="translate-links" id="translate-tamil" href="#">தமிழ்</a>
              ...
              <a class="headr-ctr" href="../contact-us/en">Get a Quote</a>
                        ...
                        <div class="top_item lang-switcher d-flex">
                            ...
                            <a class="translate-links" href="https://<?php echo $rows['apply']; ?>">New Application </a>
                    ...
                    <div class="col-12 col-sm-4 col-md-3 py-4">
                      ...
                      <p><?php echo $rows['name']; ?> was established on the 4th of October 1982 following its incorporation under the Companies Act No. 17 of 1982 as a Private Limited Liability Company in <?php echo $rows['country']; ?>’s hill capital, Kandy, as <?php echo $row['name']; ?> (Pvt) Ltd. Subsequently, it was registered as a Public Limited Liability Company under the provisions of the above Act on the 16th of December 1989 as <?php echo $row['name']; ?> Ltd.</p>
...
-->
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link " href="../help/downloads/annual-reports/en.php">Payment
                                    Protection</a>
         ...
         <div class=col-md-10 col-md-offset-1>
            <div  >
               <div class=row>
                  ...
                  <div class=col-md-7>
                     <img align=center width='300' src='img/".$image."' /><hr><br>
                  </div>
               </div>
            </div>
         </div>
...
?>
            ...
            <footer id="footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-12 footer-contact">
                                ...
                                <p class="pt-2">
                                    ...
                                    <?php echo $rows['name']; ?>, a well-established brand in the Financial Services
                                    Industry of <?php echo $rows['country']; ?>, has been one of the most sorted out
                                    financial service providers for the past decade.
                                    ...
                                    <div class="col-md-12 socil-links text-center">
                                        ...
                                        <div class="socil-links-m align-items-center">
                                            ...
                                            <div class="socil-icons">
                                                ...
                                                <a target="_blank" href="#https://www.facebook.com/comcreditlk/"><i
                                                        class="fab fa-facebook-f"></i></a>

                                                <a target="_blank"
                                                    href="#https://www.instagram.com/commercialcredit_/"><i
                                                        class="fab fa-instagram"></i></a>

                                                <a target="_blank"
                                                    href="#https://lk.linkedin.com/company/commercial-credit-limited"><i
                                                        class="fab fa-linkedin-in"></i></a>

                                                <a target="_blank"
                                                    href="#https://youtube.com/channel/UC6Rw7R8REmTE0p3OTXAfyCg"><i
                  ...
                  <a target="_blank" href="#"><i class="fab fa-whatsapp"></i></a> -->
                            ...
                            <div class="col-lg-3 col-md-4 footer-links contact">
                                ...
                                <ul>
                                    ...
                                    <li><i class="fas fa-phone-alt"></i> <a href="tel:<?php echo $rows['phone']; ?>">
                                            <?php echo $rows['phone']; ?> </a></li>



                                    <li><i class="far fa-envelope-open"></i><a
                                            href="mailTo:<?php echo $rows['email']; ?>"><span><?php echo $rows['email']; ?></span></a>
                                    </li>

                                    <!--<li><i class="fas fa-map-marker-alt"></i> <a href="#"><?php echo $rows['name']; ?>-->

                                    <!--  No.165 Kynsey Rd, Borella,<br>-->

                                    <!--  Colombo 08,<?php echo $rows['country']; ?> <br></a></li>-->

                                    <li><i class="fas fa-map-marker-alt"></i> <a target="_blank" href="#">

                                            <?php echo $rows['name']; ?><br />

                                            <?php echo $rows['addr']; ?>, <?php echo $rows['country']; ?>
              ...
              <strong><i class="fas fa-mobile-alt"></i></strong> <?php echo $rows['phone']; ?><br>

              

              <strong><i class="far fa-envelope-open"></i></strong> <?php echo $rows['email']; ?><br>

              <strong><i class="fas fa-map-marker-alt"></i></strong><?php echo $rows['name']; ?>

              No.165 Kynsey Rd, Borella,<br>

              Colombo 08,<?php echo $rows['country']; ?> <br>
              ...
              <a href="#" class="linkedin"><i class="bx bxl-linkedin"></i></a>
                                ...
                                <form class="subscriptionForm" id="subscriptionForm" action="contact/subscribe"
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" required name="subscribe_email" value=""
                                            class="form-control" placeholder="Your E-mail" aria-label="Your Email"
                        ...
                        <div class="col-md-12 disclaimer">
                            ...
                            <small class="d-block text-center text-light"><?php echo $rows['footer']; ?></small>
                    ...
                    <div class="container py-2">
                        <div class="row">
                            ...
                            <div class="col-md-8 copyright">
                                ...
                                &copy; Copyright <strong><span><?php echo $rows['name']; ?></span></strong>. All Rights
                                Reserved
    ...
    (function() {
        ...
        s1.async = true;
        s1.src = 'https://embed.tawk.to/<?php echo $rows['tawk']; ?>';
        s1.charset = 'UTF-8';
    ...
    <!-- Mirrored from <?php echo $rows['url']; ?>/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Sep 2021 16:26:18 GMT -->
