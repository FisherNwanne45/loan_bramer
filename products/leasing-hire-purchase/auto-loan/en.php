...
<div class="main-header-img">
    ...
    <img class="w-100" src="../../../uploads/sub_solution_en/SubSolution6_1648462491.jpg" alt="Breadcrumb Banner">
...
<div class="abt-single mt-4">
    ...
    <div class="container">
        ...
        <h2 class="sub-page-topic py-3">Auto Loan</h2>

        <div class="row">

            <p>Auto Loan is a special loan scheme offered by <?php echo $row['name']; ?> to its customers for the purpose of purchasing motor vehicles. Purchasing of Motor Car, Jeep and Motor Vans will be permitted under Auto Loan scheme. Manufacturing year of the registered vehicles should be within 14 years up to the date of disbursement while brand new/unregistered vehicles have no restriction.</p>
    ...
    <div class="container custom-tabs-m">
        ...
        <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade  show active   py-4" id="benefits" role="tabpanel" aria-labelledby="benefits-tab">
                        ...
                        <ul><li>Ability to go for flexible tenors.</li></ul><ul><li>Reasonable tariffs and charges in the market.</li></ul><ul><li>Offer draft facilities against vehicles.</li></ul><ul><li>Repayment facility at any <?php echo $row['name']; ?> branch.</li></ul><ul><li>Fast  approval and efficient service. <br></li></ul>
                    ...
                    <div class="tab-pane fade   py-4" id="eligibility" role="tabpanel" aria-labelledby="eligibility-tab">
                        ...
                        <ul><li>Must be a <?php echo $row['country']; ?> citizen between the age limit 18 - 60 years.</li></ul><ul><li>Clear purpose of applying the loan.</li></ul><ul><li>Having provable regular monthly income.<br></li></ul>
