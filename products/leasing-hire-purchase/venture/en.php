...
-->
        ...
        <div class="main-header-img">
            ...
            <div class="inner-topic">
                ...
                <div class="bredcrumb">
                    ...
                    <a href="en.php">Venture Capital</a>
        ...
        <div class="abt-single mt-4">
            ...
            <div class="container">
                ...
                <h2 class="sub-page-topic py-3">Venture Capital</h2>

                <div class="row">

                    <p>Venture Capital is a special loan scheme offered by <?php echo $row['name']; ?> to its customers
                        for the purpose of supporting startups and early-stage companies looking to grow rapidly.
                        <?php echo $row['name']; ?> brings extensive experience, industry knowledge, and expertise to
                        the table. We offer mentorship, guidance in strategic decisions, and advice on product
                        development, go-to-market strategies, and scaling operations.</p>
            ...
            <div class="container custom-tabs-m">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade  show active   py-4" id="benefits" role="tabpanel"
                        ...
                        <ul>
                            <li>Ability to go for flexible tenors.</li>
                        </ul>
                        <ul>
                            <li>Reasonable tariffs and charges in the market.</li>
                        </ul>
                        <ul>
                            <li>Offer draft facilities against debts.</li>
                        </ul>
                        <ul>
                            <li>Repayment facility at any <?php echo $row['name']; ?> branch.</li>
                        </ul>
                        <ul>
                            <li>Fast  approval and efficient service. <br></li>
                        </ul>
                    ...
                    <div class="tab-pane fade   py-4" id="eligibility" role="tabpanel"
                        ...
                        <ul>
                            <li>Must be a <?php echo $row['country']; ?> citizen between the age limit 18 - 60 years.
                            </li>
                        </ul>
                        <ul>
                            <li>Clear purpose of applying the loan.</li>
                        </ul>
                        <ul>
                            <li>Having provable regular monthly income.<br></li>
                        </ul>
