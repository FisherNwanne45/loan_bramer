...
-->
        ...
        <div class="main-header-img">
            ...
            <img class="w-100" src="../../../uploads/sub_solution_en/SubSolution13_1650351120.jpg"
                alt="Breadcrumb Banner">

            <div class="inner-topic">

                <h3>Start up Loans </h3>
                ...
                <div class="bredcrumb">
                    ...
                    <a href="en.php">Start up Loans</a>
        ...
        <div class="abt-single mt-4">
            ...
            <div class="container">
                ...
                <h2 class="sub-page-topic py-3">Start up Loans</h2>

                <div class="row">

                    <p>Emergencies are just a part-and-parcel of our day to day lives. But when emergencies arise, are
                        we ready financially to cover the expenses?<br />
                        <br />
                        That is why <?php echo $row['name']; ?> offers you its Start up Loans facility to help you when
                        you need quick cash. <?php echo $row['name']; ?> offers the best value for you at the most
                        competitive rates in <?php echo $row['country']; ?>.<br />
                        <br />
                        We understand the value of your business. That is why we guarantee you the safety of your start
                        up when pawned with <?php echo $row['name']; ?>, a financial institute monitored by the Central
                        Bank of <?php echo $row['country']; ?>.<br />
                        <br />
                        In an emergency, we will be there close by your doorstep - as we are operating in 130 Start up
                        Loans centers island-wide.
                    </p>
            ...
            <div class="container custom-tabs-m">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade  show active   py-4" id="benefits" role="tabpanel"
                        ...
                        <ul>
                            <li>Easy repayment schemes with lowest interest rates (1 month, 3 months, 6 months, 9
                                months).</li>
                        </ul>
                        <ul>
                            <li>Highest security and a free insurance cover for your valuables.</li>
                        </ul>
                        <ul>
                            <li>A hassle-free and fast service.</li>
                        </ul>
                        <ul>
                            <li>SMS notifications prior to the repayment date.</li>
                        </ul>
                    ...
                    <div class="tab-pane fade   py-4" id="eligibility" role="tabpanel"
                        ...
                        <ul>
                            <li>Must be a <?php echo $row['country']; ?> citizen between the age limit 18 to 80 years.
                            </li>
                        </ul>
