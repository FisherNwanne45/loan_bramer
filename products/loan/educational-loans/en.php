...
<div class="main-header-img">
    ...
    <img class="w-100" src="../../../uploads/sub_solution_en/SubSolution8_1650351144.jpg" alt="Breadcrumb Banner">
    ...
    <div class="inner-topic">
        ...
        <div class="bredcrumb">
            ...
            <a href="en.php">Educational Loans</a>
...
<div class="abt-single mt-4">
    ...
    <div class="container">
        ...
        <h2 class="sub-page-topic py-3">Educational Loans</h2>

        <div class="row">

            <p>We have tailor-made financial solutions for the students who seek both local and foreign higher education. This facility could be arranged for the total cost, including air tickets and accommodation.</p>
    ...
    <div class="container custom-tabs-m">
        ...
        <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade  show active   py-4" id="benefits" role="tabpanel" aria-labelledby="benefits-tab">
                        ...
                        <ul><li>Financially supporting aspiring children to pursue their future career path and higher education.</li></ul><ul><li>Facilitate loans to study in any desired university within the country or abroad.</li></ul><ul><li>Professional funding services for student visa.</li></ul><ul><li>Repayment facility at any <?php echo $row['name']; ?> branch. </li></ul><ul><li>Fast approval and efficient service. <br></li></ul>
                    ...
                    <div class="tab-pane fade   py-4" id="eligibility" role="tabpanel" aria-labelledby="eligibility-tab">
                        ...
                        <ul><li>Representing an immediate family member as the borrower.</li></ul><ul><li>Ability to present a valid security against the loan.</li></ul><ul><li>Must be a <?php echo $row['country']; ?> citizen holding a valid passport.<br></li></ul>
