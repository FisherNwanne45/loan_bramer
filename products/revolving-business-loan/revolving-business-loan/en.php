...
<div class="main-header-img">
    ...
    <img class="w-100" src="../../../uploads/sub_solution_en/SubSolution12_1650449570.jpg" alt="Breadcrumb Banner">

    <div class="inner-topic">

        <h3>Revolving Business Loan </h3>

        <div class="bredcrumb">

            <a href="../../../en.php">Home</a><i class="fas fa-chevron-right"></i> <a href="#">Our Solutions</a><i class="fas fa-chevron-right"></i>

            <a href="en.php">Revolving Business Loan</a>
...
<div class="abt-single mt-4">
    ...
    <div class="container">
        ...
        <h2 class="sub-page-topic py-3">Revolving Business Loan</h2>

        <div class="row">

            <p>Providing quick working capital to the Small and Medium Scale Business crowd of the town to enhance their existing business with the affordable rental which will be collected at their doorstep daily.</p>
    ...
    <div class="container custom-tabs-m">
        ...
        <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade  show active   py-4" id="benefits" role="tabpanel" aria-labelledby="benefits-tab">
                        ...
                        <ul><li>Providing speedy working capital solutions for your business.</li></ul><ul><li>Ability to select flexible and small repayment Periods.</li></ul><ul><li>Daily repayments facility via door step collection service.</li></ul><ul><li>No need to secure any property/asset .</li></ul><ul><li>Repayment facility at any <?php echo $row['name']; ?> branch.</li></ul><ul><li>Fast  approval and efficient service. </li></ul>
                    ...
                    <div class="tab-pane fade   py-4" id="eligibility" role="tabpanel" aria-labelledby="eligibility-tab">
                        ...
                        <ul><li>Must be a <?php echo $row['country']; ?> citizen between the age limit 18 - 60 years.</li></ul><ul><li>Being an entrepreneur engaged  with a registered business.</li></ul><ul><li>The minimum business exitance period has to be  two years.</li></ul><ul><li>Using a current account.<br></li></ul>
