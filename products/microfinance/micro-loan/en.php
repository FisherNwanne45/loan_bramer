...
<div class="main-header-img">
    ...
    <img class="w-100" src="../../../uploads/sub_solution_en/SubSolution9_1650351429.jpg" alt="Breadcrumb Banner">

    <div class="inner-topic">

        <h3>Debt Refinance </h3>

        <div class="bredcrumb">

            <a href="../../../en.php">Home</a><i class="fas fa-chevron-right"></i> <a href="#">Our Solutions</a><i class="fas fa-chevron-right"></i>

            <a href="en.php">Debt Refinance</a>
...
<div class="abt-single mt-4">
    ...
    <div class="container">
        ...
        <h2 class="sub-page-topic py-3">Debt Refinance</h2>
    ...
    <div class="container custom-tabs-m">
        ...
        <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade  show active   py-4" id="benefits" role="tabpanel" aria-labelledby="benefits-tab">
                        ...
                        <ul><li>Loan rental can be paid at the Credit Saving Unit (CSU).</li>
<li>Offering attractive interest rates.</li>
<li>Fast and efficient service.</li>
<li>Flexible repayment terms.</li></ul>
                    ...
                    <div class="tab-pane fade   py-4" id="eligibility" role="tabpanel" aria-labelledby="eligibility-tab">
                        ...
                        <ul><li>Customer should be an active member in an active CSU.</li>
<li>Customer should have business income from agriculture or self-employed business.</li>
<li>The loan is granted as a joint loan with spouse or relatives of the customer.</li>
<li>Group customers must be the cross guarantors to the loan.</li>
<li>Being a microfinance customer.</li>
<li>Only female applicants aged between 18 to 65 years are eligible.<br></li></ul>
