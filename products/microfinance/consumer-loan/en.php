...
<div class="main-header-img">
    ...
    <img class="w-100" src="../../../uploads/sub_solution_en/SubSolution11_1650449544.jpg" alt="Breadcrumb Banner">
...
<div class="abt-single mt-4">
    ...
    <div class="container">
        ...
        <h2 class="sub-page-topic py-3">Consumer Loan</h2>

        <div class="row">

            <p>Are you a small business owner looking to expand your business?, or are you an entrepreneur looking to start your own business and need financial assistance?<br />
<br />
The microfinance loan product of <?php echo $row['name']; ?> designed to support small and medium women entrepreneurs in <?php echo $row['country']; ?> provides tailor-made loan products after evaluating your business. You do not have to let go of your business idea or delay the expansion plans because you are short of funds.<br />
<br />
We will further provide you with entrepreneurship training and support to develop your businesses as we strongly believe in your success.<br />
Come and meet us at your nearest branch; we are looking forward to welcoming you</p>
    ...
    <div class="container custom-tabs-m">
        ...
        <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade  show active   py-4" id="benefits" role="tabpanel" aria-labelledby="benefits-tab">
                        ...
                        <ul><li>Loan rental can be paid at the Credit Saving Unit (CSU).</li></ul><ul><li>Offering attractive interest rates.</li></ul><ul><li>Fast and efficient service.</li></ul><ul><li>Flexible repayment terms.</li></ul>
                    ...
                    <div class="tab-pane fade   py-4" id="eligibility" role="tabpanel" aria-labelledby="eligibility-tab">
                        ...
                        <ul><li>Only female applicants aged between 18 to 65 years are eligible.</li></ul><ul><li>Customer should be an active member in an active CSU.</li></ul><ul><li>Customer should have business income from agriculture or self-employed business.</li></ul><ul><li>The loan is granted as a joint loan with spouse or relatives of the customer.</li></ul><ul><li>Group customers must be the cross guarantors to the loan.</li></ul><ul><li>Being a microfinance/SME customer.<br></li></ul>
