...
<div class="abt-single mt-4">
    ...
    <div class="container">
        ...
        <h2 class="sub-page-topic py-3">SME Loan</h2>

        <div class="row">

            <p>SME loans targeted at the upgraded Customers from Micro Loans where they need advanced finance facilities to fulfill their finance requirements. SME loan facility also provided with additional services to build their business further.</p>
