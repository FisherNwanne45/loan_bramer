...
<div class="main-header-img">
    ...
    <img class="w-100" src="../../../uploads/sub_solution_en/SubSolution10_1650449531.jpg" alt="Breadcrumb Banner">
    ...
    <div class="inner-topic">
        ...
        <div class="bredcrumb">
            ...
            <a href="en.php">Personal Loans</a>
...
<div class="abt-single mt-4">
    ...
    <div class="container">
        ...
        <h2 class="sub-page-topic py-3">Personal Loans</h2>

        <div class="row">

            <p>Personal Loans targeted at the upgraded Customers from Debt Refinances where they need advanced finance facilities to fulfill their finance requirements. Personal Loans facility also provided with additional services to build their business further.</p>
...
<li>Flexible repayment terms.</li></ul>
                    ...
                    <div class="tab-pane fade   py-4" id="eligibility" role="tabpanel" aria-labelledby="eligibility-tab">
                        ...
                        <ul><li>Only female applicants aged between 18 to 65 years are eligible.</li>
<li>Customer should be an active member in an active CSU.</li>
...
<li>Being a microfinance customer <br></li></ul>
